...
ARG VITE_BUYER_WEB_ORIGIN=https://kkooapp.co.tz
ENV VITE_BUYER_WEB_ORIGIN=$VITE_BUYER_WEB_ORIGIN
ARG VITE_BIZ_WEB_ORIGIN=https://biz.kkooapp.co.tz
ENV VITE_BIZ_WEB_ORIGIN=$VITE_BIZ_WEB_ORIGIN
ARG VITE_ADMIN_WEB_ORIGIN=https://admin.kkooapp.co.tz
ENV VITE_ADMIN_WEB_ORIGIN=$VITE_ADMIN_WEB_ORIGIN
